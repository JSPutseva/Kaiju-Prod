...
erDiagram
    ...
    QUARTERS ||--o{ REQUESTS : "transits through"
    USERS ||--o{ REQUESTS : "decides"

    QUARTERS ||--o{ DISASTER_LEVEL_EVENTS : "escalates"
    USERS ||--o{ DISASTER_LEVEL_EVENTS : "triggers"
```
